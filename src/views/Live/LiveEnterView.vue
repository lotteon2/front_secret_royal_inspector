<template>
  <div id="login">
    <div class="content-appid">
      ...
      <input id="appid" type="text" v-model="appid" placeholder="Please input appid" />
    </div>
    <div class="content-channel">
      <label for="channel">Channel: </label>
      <input id="channel" type="text" v-model="channel" placeholder="Please input channel" />
    </div>

    <div class="content-video-codec">
      <label for="video-codec">video codec: </label>
      <input id="video-codec" type="text" v-model="videoCodec" placeholder="Please video codec" />
    </div>
