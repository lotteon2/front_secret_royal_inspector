<template>
  <div id="meeting">
    ...
    <div class="content-operation">
      <button @click="toggleCamera">Turn {{ isCameraOn ? 'Off' : 'On' }} Camera</button>
      <button @click="toggleMicrophone">Turn {{ isMicrophoneOn ? 'Off' : 'On' }} Microphone</button>
